...
sa_res <- sa_optimize_code(
  ...
  iters = 1000000,       # adjust to your time budget (e.g., 1e5 – 5e5)
...
A SD cost of 9570.291, which means in comparison to the SGC with 9856.116, there was an improvement by:
9856.116 − 9570.291 = 285.825
A percent improvement: approximately 2.90%. This was unexpected as it was quite easy to find the codes to compute this experiment. I also made some iterations to the function by running iters = 1000000, with alpha_cool = 0.9997.
